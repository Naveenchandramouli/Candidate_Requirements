                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          ...
                                          <p class="m-b-0">Welcome to Madras Christian College</p>
                                      </div>
                                  </div>
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          <li class="breadcrumb-item">
                                              <a href="basic.php"> <i class="fa fa-home"></i> </a>
                                          </li>
...
?>
                                                                ...
                                                                <h4 class="text-c-purple"><?php echo $num ?></h4>
                                                    ...
                                                    <div class="card-footer bg-c-purple">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <p class="text-white m-b-0">No. of candidates</p>
                                                            </div>
