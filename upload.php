...
$sql="update naveen set fname='$name',lname='$lname',address='$address',dob='$dob',email='$email',mobile='$mobile',ug='$ug',pg='$pg',doct='$doct',teaching='$teaching',industry='$industry',pub='$pub',pubs='$pubs',chapter='$chapter',major='$major',minor='$minor',emp='$emp',curent='$curent',expected='$expected',doj='$doj',file='$fileName' where email='$email' ";
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <span>
                                                ...
                                                $conn=mysqli_connect($servername,$username,$password,$dbname);
                                                $sql="select id from naveen order by id";
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="email"
                                                            ...
                                                            placeholder="Enter your Email address to update" >
                                                    </div>
                                                </div>
