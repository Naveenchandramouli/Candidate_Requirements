                    ...
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" method="post" action="">
                            <div class="text-center">
                                <img src="assets/images/mcc.png" height="100" alt="mcc.png">
                            </div>
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <input type="submit" name="submit" value="Login" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20" >
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="row">
