...
$sql="update candidate set fname='$name',lname='$lname',address='$address',dob='$dob',email='$email',mobile='$mobile',ug='$ug',pg='$pg',doct='$doct',teaching='$teaching',industry='$industry',pub='$pub',pubs='$pubs',chapter='$chapter',major='$major',minor='$minor',emp='$emp',curent='$curent',expected='$expected',doj='$doj',file='$fileName' where email='$email' ";
...
if(strcmp($_POST["submit"],"Display")==0)
{
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            ...
                                            <form name="myform" method="post" action="" enctype="multipart/form-data" autocomplete="on">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Date of Joiniing <b>&nbsp*</b></label>
                                                    <div class="col-sm-10">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <center>
                                                    <input type="submit" name="submit" value="Update" onclick="return validateForm()">
